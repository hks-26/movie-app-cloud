...
public class MovieServiceTests {
    ...
    public void setUp() {
        ...
        MovieEntity movie11 = new MovieEntity("id1", 1, "Title 1", "Description 1", "image1.jpg", "bigImage1.jpg", "thumbnail1.jpg", "8.5", List.of("Genre1"), 2021, "imdbid1", "imdbLink1");
        MovieEntity movie22 = new MovieEntity("id2", 2, "Title 2", "Description 2", "image2.jpg", "bigImage2.jpg", "thumbnail2.jpg", "9.0", List.of("Genre2"), 2022, "imdbid2", "imdbLink2");
        MovieEntity movie33 = new MovieEntity("id3", 3, "Title 3", "Description 3", "image3.jpg", "bigImage3.jpg", "thumbnail3.jpg", "9.5", List.of("Genre3"), 2021, "imdbid3", "imdbLink3");
    ...
    public void testGetMoviesByRating() {
        // Mock repository
        when(movieRepo.findByRatingBetween("8.0" , "9.0"))
                .thenReturn(movieEntities);

        // Test service method
        List<MovieEntity> result = movieService.getMoviesByRating("8.0","9.0");
